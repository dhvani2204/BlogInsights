...
export default function UpdatePost() {
  ...
  return (
    ...
    <Button type='button' className='w-80 h-10 rounded-full' color='gray' pill onClick={handleUploadImage}  style={{
    ...
    {imageUploadError &&(
      ...
      <span class="font-medium">{imageUploadError}</span>
      </div>
    )}
    {formData.image &&(
      <img
...
{
  publishError && ( <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
  <span class="font-medium">{publishError}</span>
  </div>
)}
